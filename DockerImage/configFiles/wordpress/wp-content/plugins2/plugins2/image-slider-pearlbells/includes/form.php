...
class pearlDisplayForm {
    ...
    public function optionsForm() {
	  ...
	  $default_pearl_sliding_speed = get_option('pearl_sliding_spped');
          $yesCaption = ( ( get_option('pearl_caption') == 'yes' )  ) ? 'checked' : 'unchecked';
          $noCaption = ( get_option('pearl_caption') == 'no'  ) ? 'checked' : 'unchecked';
          $yesTransitionType = ( ( get_option('pearl_transition_type') == 'slide' )  ) ? 'checked' : 'unchecked';
          $noTransitionType = ( get_option('pearl_transition_type') == 'fadein'  ) ? 'checked' : 'unchecked';
          ...
          $displayOptionsForm = '
           ...
           <input type="radio" name="pearl_caption" value="yes" '.$yesCaption.'/> Yes 
           <input type="radio" name="pearl_caption" value="no" '.$noCaption.' /> No<br/>
           <label for="pearl_transition_type">Transition Type :</label>
           <input type="radio" name="pearl_transition_type" value="fadein" '.$noTransitionType.' /> Fade In/Out 
           <input type="radio" name="pearl_transition_type" value="slide" '.$yesTransitionType.' /> Slide<br/>
